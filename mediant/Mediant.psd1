...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'http://bitbucket.org/shanehoey/mediant/license.txt'

        # A URL to the main website for this project.
        ProjectUri = 'http://bitbucket.org/shanehoey/mediant/'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'http://bitbucket.org/shanehoey/mediant/release.txt'
